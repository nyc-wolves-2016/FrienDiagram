...
event1 = Event.create(host_id: per.id, venue: "Per's Palace", date: Time.now, event_type: "bar" )
event2 = Event.create(host_id: per.id, venue: "Per's Palace", date: Time.now, event_type: "bar" )
event3 = Event.create(host_id: devin.id, venue: "Time Square's Palace",  date: Time.now, event_type: "bar" )
event4 = Event.create(host_id: logan.id, venue: "Logan's Palace",  date: Time.now, event_type: "bar" )
event5 = Event.create(host_id: neel.id, venue: "Neel's Palace",  date: Time.now, event_type: "bar" )
event6 = Event.create(host_id: edwin.id, venue: "Edwin's Palace",  date: Time.now, event_type: "bar" )
